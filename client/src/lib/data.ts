...
// Gate installation steps data
export const gateInstallationSteps = [
  {
    id: "survey-gates",
    number: "01",
    title: "Предварительная оценка",
    description: "Проводим детальное обследование участка, определяем тип грунта, особенности рельефа и выполняем необходимые замеры для проектирования ворот оптимальной конструкции и размера."
  },
  {
    id: "foundation-gates",
    number: "02",
    title: "Подготовка основания",
    description: "Создаем прочное основание для опорных столбов ворот. В зависимости от типа ворот и грунта выполняем бетонирование, установку закладных деталей или подготовку фундамента."
  },
  {
    id: "frame-gates",
    number: "03",
    title: "Монтаж опорных столбов",
    description: "Устанавливаем и бетонируем опорные столбы для ворот с соблюдением вертикальности и правильного расстояния между ними. Для откатных ворот создаем дополнительный фундамент под направляющую."
  },
  {
    id: "gate-construction",
    number: "04",
    title: "Установка створок или полотна",
    description: "Монтируем створки распашных ворот или устанавливаем полотно откатных ворот на направляющую. Выполняем подгонку, регулировку и проверку корректности движения конструкции."
  },
  {
    id: "automation",
    number: "05",
    title: "Монтаж автоматики",
    description: "При необходимости устанавливаем автоматическую систему открывания: приводы, направляющие, системы безопасности. Выполняем электромонтажные работы и программирование блока управления."
  },
  {
    id: "finishing-gates",
    number: "06",
    title: "Финальная отделка",
    description: "Завершаем монтаж ворот: устанавливаем замковые механизмы, ручки, заглушки, дополнительные элементы безопасности. Проводим финальную регулировку и тестирование работы конструкции."
  }
];

// Awning installation steps data
export const awningInstallationSteps = [
  {
    id: "survey",
    number: "01",
    title: "Обследование и замеры",
    description: "Проводим детальное обследование места установки навеса, выполняем точные замеры с учетом особенностей поверхности и геометрии объекта. Составляем план монтажа и спецификацию материалов."
  },
  {
    id: "foundation",
    number: "02",
    title: "Подготовка основания",
    description: "Подготавливаем основание для крепления опорных элементов навеса. В зависимости от типа поверхности выполняем бетонирование опорных точек или усиление существующего основания."
  },
  {
    id: "frame",
    number: "03",
    title: "Монтаж несущего каркаса",
    description: "Устанавливаем опорные стойки и закрепляем их на подготовленном основании. Монтируем силовые элементы каркаса (балки, прогоны), обеспечивая необходимую жесткость и устойчивость конструкции."
  },
  {
    id: "roof",
    number: "04",
    title: "Установка кровельного материала",
    description: "Монтируем выбранный кровельный материал (поликарбонат, металлочерепица, мягкая кровля) на подготовленный каркас с соблюдением необходимых уклонов для отвода осадков."
  },
  {
    id: "drain",
    number: "05",
    title: "Монтаж водосточной системы",
    description: "Устанавливаем элементы водосточной системы (желоба, водосточные трубы) для эффективного отвода дождевой воды, защищая конструкцию навеса и прилегающую территорию от размывания."
  },
  {
    id: "finishing-awning",
    number: "06",
    title: "Финишная отделка",
    description: "Завершаем монтаж навеса: устанавливаем декоративные элементы, выполняем обработку металлических поверхностей антикоррозийными составами, проводим финальную покраску (при необходимости)."
  }
];
