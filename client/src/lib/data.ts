...
export const installationSteps = [
  {
    ...
    description: "Делаем разметку участка, используя колышки, рулетку и шнурка. Колышки выставляются на месте, где будут столбы: угловые, для ворот и калиток."
  },
  {
    id: "poles",
    number: "02",
    title: "Установка столбов",
    description: "Устанавливаем угловые опорные столбы. Затем между ними натягиваем капроновую шнурку, производим разметку и ставим остальные."
  },
  {
    id: "crossbars",
    number: "03",
    title: "Монтаж поперечин",
    description: "К столбам привариваем горизонтальные поперечины. Затем выполняем зачистку и обработку сварных швов грунтовкой или краской, которая обеспечивает антикоррозийную защиту забора."
  },
  {
    id: "fastening",
    number: "04",
    title: "Крепление",
    description: "Крепим листы к лагам посредством саморезов в каждую вторую волну."
  },
  {
    id: "gates",
    number: "05",
    title: "Установка ворот и калиток",
    description: "Устанавливаем створки ворот и калиток забора. Между столбами устанавливаем съемную стяжку. После крепления рамы к столбам обшиваем конструкцию листами металлопрофиля."
  },
  {
    id: "decoration",
    number: "06",
    title: "Декор забора",
    description: "Заключительный этап строительства забора - монтаж декоративных дуг на ворота и калитки, а также установка на верхнюю кромку листов профлиста защитной коньковой планки."
  }
];
